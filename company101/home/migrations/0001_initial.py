    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='author_create_news', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
                ('author_last_update', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='author_update_news', to=settings.AUTH_USER_MODEL, verbose_name='Автор изменения')),
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='home.category_news', verbose_name='Категория новостей')),
            ],
            options={
